...
function compareNums(num1, num2){
  ...
  // }
  // else {
  //   console.log(`These numbers are the same: ${num1}` )
  // }
...
console.log(exclaimTwo(`hello there`));  
...
function faveColorFinder(color){
  if(color === `red`){
    ...
    console.log(`${color} is soooo trendy`); 
  }
  else {
    console.log(`We need to evaluate your favorite ${color} choice`); 
  }
}
...
console.log(bestMovie(`Sharkshank Redemption`)); 
...
//CODE HERE
function makeUpper(sampleString){
...
function chocFrog(gold){
  console.log(gold/costFrog); 
}
let totalFrogs = chocFrog(4); 
...
function chocFrog2(gold){
  console.log(Math.floor(gold/costFrog)); 
}
let totalFrogs2 = chocFrog2(4); 


////////////////// PROBLEM 21 ////////////////////
let sampleArray = [0,1,2,3,4,6,5,8,9]
/*
...
console.log(checkAscending(sampleArray));
